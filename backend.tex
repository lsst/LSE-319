...
The details of these services are described in the Data Management Design Document \citedsp{LDM-148} and other associated documents; here, we only provide the high-level guidance as to the capabilities which these services will need to expose to the user (through the three Aspects).
